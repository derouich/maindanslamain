    ...
    <div className="flex min-h-screen flex-col bg-white">
      ...
      >
        <div className="container flex h-16 items-center justify-between">
          <Link href="/beta" className="flex items-center gap-2 font-serif text-xl font-medium">
          ...
          <div className="flex items-center gap-4">
            <Link href="/platforme" className="text-sm font-medium hover:text-primary hidden md:block">
              Se connecter
            </Link>
      ...
      <footer id="contact" className="bg-slate-900 text-white py-12 md:py-16">
        <div className="container px-4 md:px-6">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <Link href="/beta" className="font-serif text-2xl font-medium">
                Dr. Youness Chraibi
              </Link>
